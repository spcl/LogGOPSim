...
parser.add_argument("--ptrn", dest="ptrn", choices=["binomialtreereduce", "binarytreebcast", "dissemination"], help="Pattern to generate", required=True)
